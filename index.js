...
canvasElement.addEventListener("mousemove", (e) => {
    nearestControlPointIndex = getNearControlPoint(currentControlPoints, [e.clientX / scaleX, e.clientY / scaleY])
    if (mouseDown) {
        currentControlPoints[nearestControlPointIndex][0] = e.clientX / scaleX;
        currentControlPoints[nearestControlPointIndex][1] = e.clientY / scaleY;
        moveis = moveis.map((elem, index) => {
